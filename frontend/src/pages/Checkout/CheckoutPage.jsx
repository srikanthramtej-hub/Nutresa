...
function applyCoupon(code, subtotal) {
  ...
  if (offer.minOrder && subtotal < Number(offer.minOrder)) {
    return {
      valid: false,
      message: `Minimum order of ₹${offer.minOrder} required for this coupon`,
    };
  }
      ...
      <div className="page-wrapper">
        <div className="checkout__success">
          ...
          <div className="checkout__success-info">
            ...
            {discount > 0 && (
              <p>
                🎁 Saved ₹{discount} with coupon{" "}
                <strong>{couponInput.toUpperCase()}</strong>
              </p>
            )}
            {gstEnabled && gstAmount > 0 && (
              <p>
                🧾 GST ({gstRate}%): ₹{gstAmount} included
              </p>
            )}
          </div>
  ...
  return (
    <div className="page-wrapper">
      <div className="checkout__container">
        <button className="checkout__back-btn" onClick={handleGoBack}>
          ← Back to Cart
        </button>
        ...
        <div className="checkout__layout">
          <div>
            ...
            <div className="checkout__section">
              <h2 className="checkout__section-title">
                <span className="checkout__section-num">2</span>Promo / Coupon
                Code
              </h2>
              {!couponApplied ? (
                <div>
                  <div className="checkout__coupon-row">
                    ...
                    />
                    <button
                      className="checkout__coupon-btn btn-outline"
                ...
                <div className="checkout__coupon-applied">
                  <div className="checkout__coupon-applied-left">
                    ...
                    <div>
                      <div className="checkout__coupon-code-label">
                        {couponInput.toUpperCase()}
                      </div>
                      <div className="checkout__coupon-savings">
                        {couponResult.label}
                      </div>
                    </div>
                  </div>
              ...
              <div className="checkout__payment-list">
                {PAYMENT_METHODS.map((m) => (
                  <label key={m.id} className="checkout__payment-option">
                    ...
                    {m.id === "upi" && (
                      <span className="checkout__payment-tag">Recommended</span>
                    )}
                  </label>
                ))}
              </div>
          ...
          <div className="checkout__summary">
            ...
            <div className="checkout__sum-total">
              <span>Total</span>
              <span>₹{total}</span>
            </div>
            ...
            <button
              className="checkout__place-btn btn-primary"
              onClick={handlePlace}
              disabled={placing}
            >
            ...
            <p className="checkout__terms">
              Confirmation will be sent to <strong>{user?.email}</strong>
            </p>
          </div>
        </div>
      </div>
